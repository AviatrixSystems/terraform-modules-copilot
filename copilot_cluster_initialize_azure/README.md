...
module "init" {
  ...
  main_copilot_username                     = "admin"
  main_copilot_password                     = "Pass_word1"
  ...
  node_copilot_usernames                    = ["admin", "admin", "admin"]
  node_copilot_passwords                    = ["Pass_word1", "Pass_word1", "Pass_word1"]
