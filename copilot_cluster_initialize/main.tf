locals {
  argument_create = format("'%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s'",
    var.aws_access_key, var.aws_secret_access_key, var.controller_public_ip, var.controller_region, var.controller_username,
  ...
  argument_destroy = format("'%s' '%s' '%s' '%s' '%s' '%s'",
    var.aws_access_key, var.aws_secret_access_key, var.controller_public_ip, var.controller_region, var.main_copilot_public_ip, join(",", var.node_copilot_public_ips)
  )
}
